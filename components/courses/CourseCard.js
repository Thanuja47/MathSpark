    ...
    <>
      <div className="course-card">
        ...
        <style jsx>{`
          ...
          .free-sample-play-btn:hover .play-icon {
            color: #ffffff;
          }
      ...
      {/* Free Sample Video Modal — rendered outside .course-card so z-index works */}
      <SampleVideoModal
        isOpen={isModalOpen}
